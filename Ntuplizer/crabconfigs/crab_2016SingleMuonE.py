...
config.General.requestName = 'Wgamma94XSingleMuon_%s_2016E'%"Jan16"
config.General.workArea = 'crab_jobs_2016E_muon%s'%"Jan16"
...
config.Data.outputDatasetTag = 'Wgamma94XSingleMuon_%s_2016E'%"Jan16"
