...
config.General.requestName = 'Wgamma102XSingleMuon_%s_2018A'%"Jan16"
config.General.workArea = 'crab_jobs_2018A_muons%s'%"Jan16"
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.allowUndistributedCMSSW = True
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'config_genericA.py'
...
config.Data.outputDatasetTag = 'Wgamma102XSingleMuon_%s_2018A'%"Jan16"
