...
config.General.requestName = 'Wgamma94XSingleMuon_%s_2016D'%"Jan16"
config.General.workArea = 'crab_jobs_2016D_muon%s'%"Jan16"
...
config.Data.outputDatasetTag = 'Wgamma94XSingleMuon_%s_2016D'%"Jan16"
