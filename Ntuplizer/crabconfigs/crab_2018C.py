...
config.General.requestName = 'Wgamma102XEGamma_%s_2018C'%"Jan16"
config.General.workArea = 'crab_jobs_2018C_photon%s'%"Jan16"
...
config.Data.outputDatasetTag = 'Wgamma102XEGamma_%s_2018C'%"Jan16"
