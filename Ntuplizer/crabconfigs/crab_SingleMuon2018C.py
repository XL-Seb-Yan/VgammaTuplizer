...
config.General.requestName = 'Wgamma102XSingleMuon_%s_2018C'%"Jan16"
config.General.workArea = 'crab_jobs_2018C_muons%s'%"Jan16"
...
config.Data.outputDatasetTag = 'Wgamma102XSingleMuon_%s_2018C'%"Jan16"
