...
config.General.requestName = 'Wgamma94XSinglePhoton_%s_2016D'%"Jan16"
config.General.workArea = 'crab_jobs_2016D_photon%s'%"Jan16"
...
config.Data.outputDatasetTag = 'Wgamma94XSinglePhoton_%s_2016D'%"Jan16"
